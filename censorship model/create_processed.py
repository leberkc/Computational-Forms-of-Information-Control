...
df2= pd.read_csv('/home/leberkc/fastText/sandbox/freeweibo.clean.content.csv', sep='\t')
...
df3.to_csv(r'/home/leberkc/fastText/sandbox/freeweibo.processed.csv', index=False, sep='\t', quoting=csv.QUOTE_NONE, quotechar="", escapechar=" ")
